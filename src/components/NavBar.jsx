...
export default function NavBar() {
  return (
    <div className='h-[500px] md:h-[700px] w-full md:w-[90%] m-auto'>
    ...
    <div className='text-white absolute top-[25%] left-0 z-50 w-full flex items-center flex-col'>
        ...
        <div>
            <input type="text" name="" id="" placeholder='Looking for some burger or pizza?' className='w-[300px] md:w-[600px] p-3 md:py-4 rounded-3xl mt-4 text-black align-left px-4 border-none outline-none' />
