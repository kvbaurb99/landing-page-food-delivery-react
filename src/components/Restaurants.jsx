...
export default function Restaurants() {
  ...
  return (
    <div className='mt-[1rem] md:mt-[2rem] w-[90%] m-auto'>
        <p className='text-white text-2xl text-center md:text-start'>Trending <span className='text-green-600'>Restaurants</span></p>
