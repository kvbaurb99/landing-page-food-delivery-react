...
export default function SignUp() {
  ...
  return (
    ...
    <div className='md:w-[25%] w-[90%] h-[500px] bg-black/60 m-auto mt-[4rem] relative z-50 rounded-2xl text-white p-[4rem]'>
        ...
        <p className='mt-5 text-sm md:text-lg'>Already have account ? <Link to='/login'><span className='text-green-600 cursor-pointer'>Log in</span></Link></p>
    </div>
